...
prtcl = sphere(pos=vector(xp,yp,zp), radius=R, color=color.green) #Primera esfera
prtcls= sphere(pos=vector(xs,ys,zs), radius=R, color=color.blue)  #Segunda esfera
